...
DisplayFormat="<div class='countdown-inner'><span class='timer day'><span class='timer-inner'>%%D%%<span>Días</span></span></span><span class='timer hour'><span class='timer-inner'>%%H%%<span>Horas</span></span></span><span class='timer min'><span class='timer-inner'>%%M%%<span>Minutos</span></span></span><span class='timer sec'><span class='timer-inner'>%%S%%<span>Segundos</span></span></span></div>";if(typeof(CountActive)=="undefined")
